...
def build_model_main(args):
    if args.modelname.lower() == 'dab_detr':
        ...
        model, criterion, postprocessors, postprocess_sub, postprocess_obj = build_DABRelTR(args)
...
def main(args):
    ...
    if local_rank == 0 and world_size > 1:
        ...
        #wandb.init(project="SGG", entity="dreamer0312", id="solar-eon-194", resume="allow")
