...
def build_DABRelTR(args):
    ...
    postprocessors_sub = PostProcessSO(num_select=args.num_triplets, type='subject')
    postprocessors_obj = PostProcessSO(num_select=args.num_triplets, type='object')
